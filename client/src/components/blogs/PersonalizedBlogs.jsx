...
const PersonalizedBlogs = ({ personalizedBlogs }) => {
  ...
  return (
    <div>
      <h2 className="text-2xl lg:text-3xl font-bold to-gray-800 mb-4">
        Kişiselleştirilmiş Bloglar
      </h2>
      {personalizedBlogs?.length > 0 ? (
        ...
        <p className="text-red-500 font-semibold text-xl italic">
          Kişiselleştirilmiş blog mevcut değil.
        </p>
      )}
    </div>
  );
...
export default PersonalizedBlogs;
